                ...
                <Table>
                    <TableHeader>
                        <TableRow className="border-border hover:bg-transparent">
                            ...
                            <TableHead className="text-white font-semibold">Health Score</TableHead>
                            <TableHead className="text-white font-semibold text-right">Open Tasks</TableHead>
                            <TableHead className="text-white font-semibold text-right">Active Leads</TableHead>
                        </TableRow>
                    </TableHeader>
                    <TableBody>
